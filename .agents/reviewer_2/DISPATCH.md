...
### Identity & Context
- Role: Independent Reviewer 2 (archetype: `teamwork_preview_reviewer`)
...
3. Write your review report in `/Users/arslan/code/derslik/.agents/reviewer_2/handoff.md` with your explicit verdict: `APPROVE` or `REQUEST_CHANGES`.
